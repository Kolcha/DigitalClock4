...
QT_PATH="$HOME/Programming/Qt/5.3/gcc_64/bin"
...
# all app files to target folder
cp digital_clock/digital_clock "$TARGET_APP_FOLDER/"
cp clock_common/libclock_common.so.1.0.3 "$TARGET_APP_FOLDER/libclock_common.so.1"
cp skin_draw/libskin_draw.so.1.2.2 "$TARGET_APP_FOLDER/libskin_draw.so.1"
