...
export QT_ROOT="/usr/local/Qt-5.6.3"
...
cp clock_common/libclock_common.so.1.1.4 "$TARGET_APP_FOLDER/libclock_common.so.1"
cp plugin_core/libplugin_core.so.1.1.2 "$TARGET_APP_FOLDER/libplugin_core.so.1"
cp skin_draw/libskin_draw.so.1.3.2 "$TARGET_APP_FOLDER/libskin_draw.so.1"
