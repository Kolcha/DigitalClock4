...
[[ -n $QT_ROOT ]] || QT_ROOT="/usr/local/Qt-5.12.0"
...
cp plugin_core/libplugin_core.1.3.1.dylib digital_clock/digital_clock.app/Contents/Frameworks/libplugin_core.1.dylib
