...
QT_ROOT="/Users/nick/Qt/5.9.1/clang_64"
...
cp plugin_core/libplugin_core.1.1.1.dylib digital_clock/digital_clock.app/Contents/Frameworks/libplugin_core.1.dylib
